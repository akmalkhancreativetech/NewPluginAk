...
class CustomPostTypeController extends BaseController
 {
    ...
    public function setSettings()
    {
      $args = array(
        array(
              'option_group' => 'new_plugin_cpt_settings',
              'option_name' => 'new_plugin_cpt',
    ...
    {
      $options = get_option('new_plugin_cpt');
