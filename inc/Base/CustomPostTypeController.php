...
class CustomPostTypeController extends BaseController
 {
    ...
    public function setSettings()
    {
      $args = array(
        array(
              'option_group' => 'new_plugin_ak_cpt_settings',
              'option_name' => 'new_plugin_ak_cpt',
    ...
    public function setFields()
    {
      $args = array(
        array(
          ...
          'page' => 'new_plugin_ak_cpt',
          'section' => 'new_plugin_ak_cpt_index',
          'args' => array(
              'option_name' => 'new_plugin_ak_cpt',
              'label_for' => 'post_type',
    ...
    {
      $options = get_option('new_plugin_ak_cpt');
